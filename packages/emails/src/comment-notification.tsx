		...
		<Html lang='en-US'>
			...
			>
				...
				>
					...
					>
						<Img
							src='https://sotiesman.tech/images/email/logo.png'
							alt="Sotiesman's logo"
							width='50'
							height='50'
						/>
					</Section>
					<Section>
						<Text>
							...
							on the post &quot;{post.title}&quot; on sotiesman.tech
						</Text>
					</Section>
					<Hr
						style={{
					...
					<Section>
						...
						>
							View {type === 'comment' ? 'comment' : 'reply'} on sotiesman.tech
						</Link>
					</Section>
				</Container>
			</Body>
