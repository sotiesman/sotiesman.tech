	...
	return [
		{
			name: 'sdnsdev:react',
			plugins: {
				'@eslint-react': plugins['@eslint-react'] as Record<
					string,
					ESLint.Plugin
				>,
				'@eslint-react/dom': plugins['@eslint-react/dom'] as Record<
					string,
					ESLint.Plugin
				>,
				'react-hooks': reactHooksPlugin,
				'@eslint-react/hooks-extra': plugins[
					'@eslint-react/hooks-extra'
				] as Record<string, ESLint.Plugin>,
				'@eslint-react/naming-convention': plugins[
