...
export const flags = {
  ...
  guestbookNotification:
	...
	discordAvatar: isProduction || process.env.NEXT_PUBLIC_FLAG_UPLOAD_DISCORD_AVATAR === 'true',
...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_FLAG_GUESTBOOK_NOTIFICATION: z.string().min(1).optional(),
		NEXT_PUBLIC_FLAG_UPLOAD_DISCORD_AVATAR: z.string().min(1).optional(),
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_FLAG_GUESTBOOK_NOTIFICATION: process.env.NEXT_PUBLIC_FLAG_GUESTBOOK_NOTIFICATION,
		NEXT_PUBLIC_FLAG_UPLOAD_DISCORD_AVATAR: process.env.NEXT_PUBLIC_FLAG_UPLOAD_DISCORD_AVATAR,
